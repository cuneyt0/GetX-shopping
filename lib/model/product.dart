...
class Product {
  ...
  factory Product.fromJson(Map<String, dynamic> json) => Product(
    ...
    category: json["category"] == null ? "bilinmiyor" : json["category"],
    ...
    productColors: List<ProductColor>.from(json["product_colors"].map((x) => ProductColor.fromJson(x))), brand: null,
  );
  ...
  Map<String, dynamic> toJson() => {
    ...
    "rating": rating == null ? 1.0 : rating,
    "category": category == null ? "bilinmiyor" : category,
